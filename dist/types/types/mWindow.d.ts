...
export interface MWindow extends Omit<Uptimerobot.MWindow, 'type' | 'status' | 'start_time'> {
    type: MWindowType;
    status: MWindowState;
...
export interface MWindowListResponse extends Omit<Uptimerobot.MWindowListSuccessResponse, 'stat' | 'pagination' | 'mwindows'> {
    stat: Stat;
...
export interface MWindowCreateRequest extends Omit<Uptimerobot.MWindowCreateRequest, 'type' | 'start_time'> {
    type: MWindowType;
    start_time?: MWindowStartTime;
}
