...
export interface MonitorCreateRequest extends Omit<Uptimerobot.MonitorCreateRequest, 'type' | 'sub_type' | 'keyword_type' | 'http_method' | 'post_type' | 'post_content_type' | 'alert_contacts' | 'custom_http_statuses' | 'ignore_ssl_errors'> {
    type: MonitorType;
    sub_type?: MonitorSubType;
    keyword_type?: MonitorKeywordType;
...
export interface MonitorEditRequest extends Omit<Uptimerobot.MonitorEditRequest, 'sub_type' | 'keyword_type' | 'http_method' | 'post_type' | 'post_content_type' | 'alert_contacts' | 'custom_http_statuses' | 'ignore_ssl_errors'> {
    sub_type?: MonitorSubType;
    keyword_type?: MonitorKeywordType;
    http_method?: MonitorHttpMethod;
    post_type?: MonitorHttpMethodPostType;
