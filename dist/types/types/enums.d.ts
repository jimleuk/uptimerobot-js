 ...
 */
export declare enum AlertContactType {
    sms = 1,
    email = 2,
    twitter = 3,
    boxcar = 4,
...
export declare enum AlertContactState {
    /** pending activation */
    pending = 0,
    paused = 1,
    active = 2
 ...
 */
export declare enum MonitorSubType {
    none = 0,
    http = 1,
    https = 2,
    ftp = 3,
 ...
 */
export declare enum MonitorKeywordType {
    none = 0,
    exists = 1,
    notExists = 2
}
 ...
 */
export declare enum MonitorState {
    paused = 0,
    new = 1,
    up = 2,
    warn = 8,
...
export declare enum MonitorHttpMethod {
    head = 1,
    get = 2,
    post = 3,
    put = 4,
 ...
 * methods
 */
export declare enum MonitorHttpMethodPostType {
    keyValue = 1,
    rawData = 2
}
/** The Content-Type for POST, PUT, PATCH, DELETE, OPTIONS HTTP methods */
export declare enum MonitorHttpMethodContentType {
    /** text/html */
    html = 0,
    /** application/json */
    json = 1
...
export declare enum MWindowType {
    once = 1,
    daily = 2,
    weekly = 3,
    monthly = 4
...
export declare enum MWindowState {
    paused = 0,
    active = 1
}
/** The status of the status page. 0 - paused or 1 - active */
export declare enum PSPState {
    paused = 0,
    active = 1
}
/** The sorting of the status page */
export declare enum PSPSort {
    /** friendly name (a-z) */
    friendlyNameAsc = 1,
    /** friendly name (z-a) */
    friendlyNameDesc = 2,
